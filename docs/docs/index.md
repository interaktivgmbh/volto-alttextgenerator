...
myst:
  html_meta:
    "description": "The Volto add-on for interaktiv.alttextgenerator"
    "property=og:description": "The Volto add-on for interaktiv.alttextgenerator"
    "property=og:title": "Interaktiv Alt Text Generator"
    "keywords": "Interaktiv Alt Text Generator, documentation, The Volto add-on for interaktiv.alttextgenerator"
---

# Interaktiv Alt Text Generator

Welcome to the documentation for Interaktiv Alt Text Generator!
